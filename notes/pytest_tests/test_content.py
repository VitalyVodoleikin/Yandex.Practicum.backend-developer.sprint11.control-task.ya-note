...
# # ---------->
# # Можно оставить тесты и в таком виде, а можно объединить
# # их в один и использовать параметризацию тестов, чтобы
# # не дублировать код. 
# # В написанных тестах в assert-выражениях применены
# # разные сравнения — in и not in. При объединении тестов
# # можно использовать одну и ту же конструкцию in, но
# # сравнивать её со значениями True и False.
